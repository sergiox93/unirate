...
class ProfesorsControllerTest < ActionController::TestCase
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post :create, profesor: { correo: @profesor.correo, nombre: @profesor.nombre, password: @profesor.password, usuario: @profesor.usuario }
    end
  ...
  test "should update profesor" do
    patch :update, id: @profesor, profesor: { correo: @profesor.correo, nombre: @profesor.nombre, password: @profesor.password, usuario: @profesor.usuario }
    assert_redirected_to profesor_path(assigns(:profesor))
  end
