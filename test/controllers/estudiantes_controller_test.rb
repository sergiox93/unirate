...
class EstudiantesControllerTest < ActionController::TestCase
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post :create, estudiante: { correo: @estudiante.correo, nombre: @estudiante.nombre, password: @estudiante.password, usuario: @estudiante.usuario }
    end
  ...
  test "should update estudiante" do
    patch :update, id: @estudiante, estudiante: { correo: @estudiante.correo, nombre: @estudiante.nombre, password: @estudiante.password, usuario: @estudiante.usuario }
    assert_redirected_to estudiante_path(assigns(:estudiante))
  end
